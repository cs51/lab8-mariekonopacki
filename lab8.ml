...
......................................................................*)
  ...
  let add_listener (evt : 'a event) (listener : 'a -> unit) : id =
    let evt_prev = !evt in
    let iD = new_id () in
    evt := evt_prev @ [{id = iD; action = listener }];
    iD
...
......................................................................*)
  ...
  let remove_listener (evt : 'a event) (i : id) : unit =
    let evt_new = List.filter (fun a -> a.id <> i) !evt in
    evt := evt_new
...
let testh1 = WEvent.fire_event newswire h1;;
let testh2 = WEvent.fire_event newswire h2;;
let testh3 = WEvent.fire_event newswire h3;;
...
let recieve = WEvent.add_listener newswire receive_report ;;
...
let test4 = WEvent.fire_event newswire h4;;
...
the line above.
......................................................................*)
let test5 = WEvent.fire_event publish ();;
(* .. *)
